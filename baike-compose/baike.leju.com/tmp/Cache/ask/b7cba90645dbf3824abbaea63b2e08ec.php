				...
				<ul class="menu">
					...
					<li class="<?php echo $item['id']==$cateid ? 'cur' : ''; ?>">
						...
						<div class="menu_ly_wrap">
							<?php
 $ic = 0; $cnt = count($item['son'])-1; foreach ( $item['son'] as $kk => $lv2 ) { ?>
	...
	<div class="ty_content clearfix">
		<div class="ty_404content">
			...
			<h3 class="ty_404tit"><?php echo ($error_message); ?></h3>
			<i class="line"></i>
	...
	<div class="z_bt_nav ty_bt_nav">
		<div class="inner clearfix">
			...
			<div class="nav_box">
				...
				<?php
 foreach ( $result['kb'] as $k => $tag ) { echo '<a href="', $tag['url'], '">', $tag['title'], '</a>', PHP_EOL; } ?>
				</div>
			</div>
			<?php } ?>
			<?php if ( $result['tag'] ) { ?>
			<div class="nav_box">
				...
				<?php
 foreach ( $result['tag'] as $k => $tag ) { echo '<a href="', $tag['url'], '">', $tag['title'], '</a>', PHP_EOL; } ?>
				</div>
			</div>
			<?php } ?>
		</div>
