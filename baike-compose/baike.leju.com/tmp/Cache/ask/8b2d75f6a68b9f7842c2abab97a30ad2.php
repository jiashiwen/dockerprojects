...
<div class="sWrap">
	<div class="sCrumbs">
		<a href="/">问答首页</a>
		<?php if ( $cateinfo['level']==1 ) { ?>
		<span>\</span>
		<a class="cur" href="javascript:;"><?php echo ($cateinfo["name"]); ?></a>
		<?php } ?>
		<?php if ( $cateinfo['level']==2 ) { ?>
		<?php $parent_cateinfo = $catetree[$cateinfo['pid']]; ?>
		<span>\</span>
		<a href="<?php echo url('list', array($cateinfo['pid']), 'pc', 'ask'); ?>"><?php echo ($parent_cateinfo["name"]); ?></a>
		<span>\</span>
		<a class="cur"><?php echo ($cateinfo["name"]); ?></a>
		<?php } ?>
	</div>
	<div class="clearfix">
		<div class="sLbox">
			<div class="sTit">
				<?php echo ($cateinfo["name"]); ?>
				<div class="fr sort">
