...
<div class="z_main_menu">
	...
	<?php if(!empty($sortId)): ?><div class="ty_bread">
			<a target="_blank" href="<?php echo url('index', array(), 'pc', 'baike'); ?>" title="房产百科">房产百科</a><i></i>
			<a class="on"><?php echo ($sortId); ?></a>
		</div><?php endif; ?>
		...
		<div class="b_right ty_bright">
			...
			<div class="ty_slid">
				<?php if(is_array($binds["nav"]["son"])): $i = 0; $__LIST__ = $binds["nav"]["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cc): $mod = ($i % 2 );++$i;?><h3><?php echo ($cc["name"]); ?><i></i></h3>
					<p>
						<?php if(is_array($cc["son"])): $i = 0; $__LIST__ = $cc["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ccc): $mod = ($i % 2 );++$i;?><a target="_blank" href="<?php echo url('cate', array('id'=>$ccc['id'], 'page'=>1), 'pc', 'baike');?>"><?php echo ($ccc["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="ty_right">
		<h2 class="ty_tit">
			<i></i><span>关键词 “<strong style="color:red;"><?php echo ($sortId); ?></strong>” 相关知识</span>
		</h2>
		<div class="ty_list">
			<ul>
